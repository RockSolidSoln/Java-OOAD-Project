...
public class AdminProjectsView extends JFrame {
        ...
        public static AdminProjectsView getInstance() {
                if (singletonInstance == null) {
                        singletonInstance = new AdminProjectsView();
                }
        ...
        private void initComponents() {
                ...
                jTable1.setModel(new DefaultTableModel(
                                ...
                                new String[] {
                                                "Project ID", "Project Name", "Lecturer Id", "Project Specialization",
                                                "Details"
                                }) {
                ...
                jPanel4Layout.setHorizontalGroup(
                                jPanel4Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                                                ...
                                                .addGroup(jPanel4Layout.createSequentialGroup()
                                                                .addGap(17, 17, 17)
                                                                .addComponent(jButton5, GroupLayout.PREFERRED_SIZE, 113,
                ...
                jPanel4Layout.setVerticalGroup(
                                jPanel4Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                                                .addGroup(GroupLayout.Alignment.TRAILING, jPanel4Layout
                                                                ...
                                                                .addGap(25, 25, 25)
                                                                .addComponent(jLabel6, GroupLayout.PREFERRED_SIZE, 25,
                                                                                GroupLayout.PREFERRED_SIZE)
                                                                .addGap(87, 87, 87)
                                                                .addComponent(jButton2)
                                                                .addGap(12, 12, 12)
